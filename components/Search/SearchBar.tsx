...
export default function SearchBar() {
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full mb-4">
      ...
      {/* Search button */}
      <button className="bg-primary-red hover:bg-primary-red text-white font-medium px-6 py-3 sm:py-2 rounded-md whitespace-nowrap transition-colors duration-200 w-full sm:w-auto font-secondary">
        Search
      </button>
    </div>
  );
